...
const Takeshi = () => {
  ...
  const [takeshiData, setTakeshiData] = useState([]); // Updated state variable
  const [loading, setLoading] = useState(false);
  const takeshiCollectionRef = collection(db, 'takeshi'); // Updated to 'takeshi' collection

  const getData = async () => {
    setLoading(true);
    const data = await getDocs(takeshiCollectionRef);
    ...
    setTakeshiData(
      data.docs.map((doc) => ({
        ...
        leaderPhone: doc.data().leaderPhone,
        leaderBranch: doc.data().leaderBranch,
        leaderEmail: doc.data().leaderEmail,
        member2Name: doc.data().member2Name,
        member2Phone: doc.data().member2Phone,
        member2Email: doc.data().member2Email,
        member3Name: doc.data().member3Name,
        member4Name: doc.data().member4Name,
        id: doc.id,
      }))
    );
    setTimeout(() => {
