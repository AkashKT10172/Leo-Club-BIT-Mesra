  ...
  return (
    <div className='Acontainer overflow-x-hidden'>
     <div className='imgdiv flex h-auto relative max-h-[96vh] justify-center -m-1'>
      ...
      <p className='font-nova text-[18px] text-blue-900  text-justify' >Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur euismod magna at laoreet rutrum. Donec sed odio dui. Fusce dapibus, tellus quis lacinia congue, erat lorem pulvinar nunc, condimentum feugiat nisl purus pretium nulla.
